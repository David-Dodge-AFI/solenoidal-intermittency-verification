#!/bin/bash
# Run all verification scripts for Paper 2: Turbulence Intermittency
# Categories 01-02 + 04: pure math (no external data needed)
# Category 03: requires JHTDB access (slow, rate-limited)
